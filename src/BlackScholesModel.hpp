...
public:
    ...
    PnlMat *corr; /// Transformée de Cholesky de la matrice corrélation
    PnlVect *trend_; /// le paramétre de tendance
    PnlVect *G;
	PnlVect *Ld;
    ...
    /**
     * Simule les données du marché
     *
     * @param[out]  path contient la trajectoire
     * du sous-jacent
     * @param[in] T date jusqu'à laquelle on simule la trajectoire
     * @param[in] H Nombre de dates de couverture
     */
